  ...
  return (
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center bg-gray-50">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">State Not Found</h2>
        <p className="text-gray-600 mb-8">The state you&apos;re looking for doesn&apos;t exist in our system.</p>
        <Link
          href="/"
